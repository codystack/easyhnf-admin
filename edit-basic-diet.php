...
require_once "./auth/update.php";
    ...
    $select_query = "SELECT * FROM basic_diet WHERE diet_id='$diet_id'";
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h4 class="display-4 text-primary font-weight-bold"><?php echo $title; ?></h4>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="">
                                            ...
                                            <form class="needs-validation" novalidate action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST">
                                                <div class="row mb-4 mt-4">
                                                    <div class="col-md-6 mx-auto" style="display: none">
                                                        <div class="form-group">
                                                            <label for="title">Basic Diet</label>
                                                            <input type="text" class="form-control" name="diet_id" value="<?php echo $diet_id; ?>">
                                                        </div>
                                                    </div>
                                                ...
                                                <button name="update_basic_diet_btn" type="submit" class="button btn-block btn btn-primary btn-lg mr-2" onclick="this.classList.toggle('button--loading')"><span class="button__text">Update diet</span></button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
