                    <div class="row">
                        <div class="col-md-12 col-lg-4 grid-margin stretch-card">
                            <div class="card bg-gradient-primary text-white text-center card-shadow-primary">
                                <div class="card-body">
                                    <h6 class="font-weight-normal">Residents</h6>
                                    <?php
                                        $countResidents = mysqli_query($conn, "SELECT id FROM users");
                                    echo "<h2 class='mb-0'>".number_format(mysqli_num_rows($countResidents), 0, '.', ',')."</h2>"
                                    ?>
                                </div>
                            </div>
                        </div>
