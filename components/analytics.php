                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3 grid-margin stretch-card">
                            <div class="card bg-gradient-primary text-white text-center card-shadow-primary">
                                <div class="card-body">
                                    <h6 class="font-weight-normal mb-3">Total Custom Meal Plans</h6>
                                    <?php
                                        $countMealPlan = mysqli_query($conn, "SELECT plan_id FROM custom_meal_plan");
                                    echo "<h2 class='mb-0 font-weight-bold'>".number_format(mysqli_num_rows($countMealPlan), 0, '.', ',')."</h2>"
                                    ?>
                                </div>
                            </div>
                        </div>
